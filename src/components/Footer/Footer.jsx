      ...
      <div className="w-full bg-[#474E68] text-white">
        <div className="max-w-screen-xl mx-auto text-center">
          <p className="text-3xl pt-20">
            Join our parking revolution and be up to date with the coming
            changes!
          </p>
          ...
          <p className="lg:text-3xl md:text-3xl text-3xl mt-20 md:mt-3 lg:mt3  mx-auto">
          ...
          <div className="lg:flex md:flex md:w-[45%] lg:w-[45%] mx-auto pt-10">
            ...
            <span className="lg:mx-2 md:mx-2 lg:text-white md:text-white text-transparent">
              |
            </span>
          ...
          <div className="lg:flex md:flex lg:w-[22%] md:w-[22%] mx-auto lg:pt-3 md:pt-3 pt-6">
            <p className="hover:underline">+48 22 777 41 41</p>{" "}
            <span className="mx-2 text-transparent lg:text-white md:text-white">
              |
            </span>
          ...
          <div className="lg:grid md:grid lg:grid-cols-4 md:grid-cols-4 pt-10 w-full">
            ...
            <p className="col-span-2 lg:pt-2 md:pt-2 pt-5 lg:w-full md:w-full w-[90%] mx-auto text-[#d6d3d3] font-light">
              ShareP AG © 2024 - All rights reserved -{" "}
              <span className="hover:underline">Privacy Policy</span> -{" "}
              <span className="hover:underline">Terms of Use</span>
            </p>
            <div className="col-span-1 pb-5 lg:pt-0 md:pt-0 pt-10">
              <button className="text-4xl mx-2">
                <FaFacebook />
              </button>
              <button className="text-4xl mx-2">
                <FaLinkedin />
